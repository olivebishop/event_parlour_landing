    ...
    <div className="relative min-h-screen flex items-center justify-center lg:bg-gradient-to-b lg:from-black lg:to-[#171717] lg:mt-6 w-full">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[url('/images/two.png')] bg-cover bg-center bg-no-repeat opacity-25 backdrop-blur-[2px]" />
          
          {/* Refined Overlay with better gradient for subtle background visibility */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/85 via-[#171717]/90 to-black/85" />
        </div>
